...
- (void)viewDidLoad
{
    ...
    if (self){
        ...
        float btnWidth = roundf(screenBoundsSize.width/2);
        ...
        UILabel *msg = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, screenBoundsSize.width, 20)];
        ...
        btnCancel.y = btnCrop.y = screenBoundsSize.height - btnCancel.height;
        msg.y = btnCancel.y - msg.height;
        [contentView addSubview:btnCrop];
        [contentView addSubview:msg];
        
        CGRect view = CGRectMake(0, 20, screenBoundsSize.width, screenBoundsSize.height - msg.height - btnCancel.height - 20);
