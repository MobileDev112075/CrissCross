...
- (void)setDefaults {
    ...
    self.gradientColors = @[[UIColor colorWithHexString:COLOR_CC_BLUE],[UIColor colorWithHexString:COLOR_CC_TEAL],[UIColor colorWithHexString:COLOR_CC_GREEN]];
...
//        
        ...
        CGPoint endPoint = CGPointMake(CGRectGetWidth(textRect),0);
